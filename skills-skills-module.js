...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<ion-header [translucent]=\"true\">\n  <ion-toolbar class=\"item-background-color\">\n    <ion-buttons slot=\"start\">\n      <ion-menu-button></ion-menu-button>\n    </ion-buttons>\n    <ion-title>Skills</ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content class=\"ion-padding\">\n\n  <ion-list class=\"item-background-color\">\n    <ion-item class=\"item-background-color\">Languages: R (Standard), Java (Basic), Nodejs (Basic), AngularJS (Standard)</ion-item>\n    <ion-item class=\"item-background-color\">Computer skills: Git (Standard),Linux (Standard)</ion-item>\n    <ion-item class=\"item-background-color\">\n      Softwares: Tableau (Standard), Excel (Standard)</ion-item>\n    <ion-item class=\"item-background-color\">\n      Editors: VScode(Expert), Jupyter(Expert), Spyder(Standard), Vim(Standard)</ion-item>\n    <ion-item class=\"item-background-color\">\n      Platforms: GCP-Virtual Machine (Basic), Firebase(Expert), Google Play Console(Expert)</ion-item>\n    <ion-item class=\"item-background-color\">\n      Database: SQL (Basic)</ion-item>\n    <ion-item class=\"item-background-color\">\n      Concepts: NLP (Basic), ETL (Basic)</ion-item>\n    <ion-item class=\"item-background-color\">\n      Frameworks: Gunicorn (Basic). Flask (Basic), Django (Standard)</ion-item>\n    <ion-item class=\"item-background-color\">\n      Libraries: Pandas (Standard), Scikit-Learn (Standard), Numpy (Standard)</ion-item>\n  </ion-list>\n</ion-content>");
